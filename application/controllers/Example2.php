...
class Examples extends CI_Controller {
	...
	public function user()
	{
			...
			$crud->set_table('user');
			$crud->columns('iduser','fullname','email');
	...
	public function medis()
	{
			...
			$crud->columns('noinvoice','nickname','jasa', 'obat','total','bayar','kembali');
			$crud->display_as('noinvoice','No Nota')
				 ->display_as('nickname','Admin')
				 ->display_as('jasa','Jasa')
				 ->display_as('obat','Obat')
				 ->display_as('total','Total Harga')
				 ->display_as('bayar','Bayar')
